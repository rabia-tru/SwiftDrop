...
/// SwiftDrop Rider Register — Orange & White Only
...
class _RegisterScreenState extends State<RegisterScreen> {
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
            child: Column(
              children: [
                // ─── Header with Back Button (matching design) ───
                Stack(
                  children: [
                    Container(
  ...
  Widget _buildFormContent() {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Text('Create Account', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700, color: AppColors.black)),
  ...
  Widget _buildVehicleDropdown() {
    return DropdownButtonFormField<String>(
      ...
      items: const [
        DropdownMenuItem(value: 'bike', child: Row(children: [Icon(Icons.pedal_bike, size: 18, color: AppColors.orange), SizedBox(width: 10), Text('Bike')])),
        DropdownMenuItem(value: 'car', child: Row(children: [Icon(Icons.directions_car, size: 18, color: AppColors.orange), SizedBox(width: 10), Text('Car')])),
        DropdownMenuItem(value: 'van', child: Row(children: [Icon(Icons.local_shipping, size: 18, color: AppColors.orange), SizedBox(width: 10), Text('Van')])),
      ],
